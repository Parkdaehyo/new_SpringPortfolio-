...
<html lang="ko">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="<c:url value='/board/req_album'/>">MusicVideo</a></li>
         ...
         <c:if test="${not empty login}" >
          ...
          <li class="nav-item mx-0 mx-lg-1">										<!-- LOGOUT 누르면 onclik이 작동되도록 하고, 컨트롤러에서 /user/logout을 처리하는 메서드 만들기. -->
    ...
    <c:if test="${login != null}" >
    	<li class="nav-item mx-0 mx-lg-1">		  								<!-- -session.setAttribute("login", dbData);에 의해서 login에는 UserVO에 데이터가 담겨져있으므로 login.name해서 DB계정을 출력.  EL에서는 getter생략. -->
        ...
        <!-- BoardController 116번 write 요청에 대하여
		
		home으로 돌아갔을때 보이는 메세지
